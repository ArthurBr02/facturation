...
export const facturesApi = {
  ...
  pdfSigne: (id) => http.get(`/factures/${id}/pdf-signe`, { responseType: 'blob' }).then((r) => r.data),
  uploadSigne: (id, base64Data) => http.post(`/factures/${id}/upload-signe`, { data: base64Data }).then((r) => r.data),
...
export const contratsApi = {
  ...
  pdfSigne: (id) => http.get(`/contrats/${id}/pdf-signe`, { responseType: 'blob' }).then((r) => r.data),
  uploadSigne: (id, base64Data) => http.post(`/contrats/${id}/upload-signe`, { data: base64Data }).then((r) => r.data),
